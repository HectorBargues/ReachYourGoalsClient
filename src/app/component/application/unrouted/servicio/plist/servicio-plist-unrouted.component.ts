...
@Component({
  selector: 'app-servicio-plist-unrouted',
  templateUrl: './servicio-plist-unrouted.component.html',
  styleUrls: ['./servicio-plist-unrouted.component.css']
})
export class ServicioPlistUnroutedComponent implements OnInit {
